...
if __name__ == '__main__':
    SETUP_CODE = '''
import sys
sys.path.insert(0,'/Users/caiyusheng/Desktop/Research/Research_code/SWIPES/swipes/test')
...
iso = isosurface(box,ngrids,sigma=3.4,n=3,kdTree=True)
'''

    RUN_CODE = '''
iso.field_density_kdtree(pos,d=np.array([0,1,1]))
'''
